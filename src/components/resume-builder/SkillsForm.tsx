  ...
  return (
    <div className="space-y-6 pb-24 lg:pb-10">
      <div>
        ...
        <p className="text-sm text-[var(--text-muted)] mb-6">Group your skills into categories.</p>
      </div>

      <div className="space-y-4">
        {skills.map((skill) => (
           <div key={skill.id} className="flex flex-col md:flex-row gap-3 items-start md:items-center bg-[var(--surface)] md:bg-transparent p-4 md:p-0 rounded-xl border border-[var(--border)] md:border-none">
             ...
             <div className="w-full md:w-full flex gap-2">
                ...
                <button 
                  ...
                  className="px-4 bg-[var(--danger)]/10 text-[var(--danger)] rounded-lg hover:bg-[var(--danger)]/20 transition-colors flex items-center justify-center min-w-[50px]"
                >
                    🗑️
                </button>
             </div>
