                    ...
                    <div className="max-w-4xl mx-auto space-y-6 mt-8">
                        ...
                        {result.matchedRoles && result.matchedRoles.length > 0 && (
                            <div className="p-6 bg-[var(--surface)] border border-[var(--border)] rounded-lg">
                                <h3 className="text-lg font-bold text-[var(--text)] mb-4">AI Career Advisor: Best Role Matches</h3>
                                <div className="space-y-4">
                                    {result.matchedRoles.map((match: any, i: number) => (
                                        <div key={i}>
                                            <div className="flex justify-between text-sm mb-1">
                                                <span className="text-[var(--text)] font-medium">{match.role}</span>
                                            ...
                                            {/* Progress Bar */}
                                            <div className="w-full bg-[var(--bg)] rounded-full h-2.5 border border-[var(--border)] overflow-hidden">
                                                <div
                                                    className={`h-2.5 rounded-full ${match.matchPercentage >= 80 ? 'bg-[var(--success)]' : match.matchPercentage >= 50 ? 'bg-[var(--warning)]' : 'bg-[var(--danger)]'}`}
